...
| ------------  | --------------- | -------------------------------------- |-----------------------------------------------------------------------|
| Oct 9, 2026 | Dong Xia | The Hong Kong University of Science and Technology | [Learning and Inference from Tensors](https://www.hkubs.hku.hk/event/learning-and-inference-from-tensors/) |
...
| Nov 28, 2025 | Linbo Wang | University of Toronto | [Causal Inference: A tale of three frameworks](https://www.hkubs.hku.hk/event/causal-inference-a-tale-of-three-frameworks/) |
...
Current Web maintainer: Lei Shiqi (u3011793@connect.hku.hk). Last update on Apr 14, 2026. 
